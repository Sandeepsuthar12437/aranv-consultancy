  ...
  return (
    <section className="py-[88px] bg-[#f9f8f8]">
      <div className="max-w-[1200px] w-full mx-auto px-[15px]">
        ...
        <h2
          className="text-xl md:text-[40px] font-bold max-w-[970px] pr-7 md:mb-14 xl:mb-28 leading-[30px] md:leading-[48px]"
        ...
        <div className="flex flex-col relative">
          ...
          <ul
            className={`xl:w-[83%] w-full  flex flex-row flex-wrap ${
              data.technologies ? "bg-red-500" : ""
            }`}
          >
            {data.technologies &&
